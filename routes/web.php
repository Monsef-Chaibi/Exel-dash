...
Route::group(['middleware' => ['checkUserRole:0', 'auth' ]], function () {
    ...
    Route::get('/SadadStatus', [Controller::class, 'SadadStatus'])->name('SadadStatus');
    ...
    Route::get('/PDFCheck/{id}', [Controller::class, 'PDFCheck'])->name('PDFCheck');
...
Route::post('/GetArchive', [Controller::class, 'GetArchive'])->name('GetArchive');
