  ...
  <script>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <a href="/ViewData">
                <button style="color:rgb(103, 255, 103);padding:10px;font-size:30px">View Data &rarr;</button>
            </a>
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex">
                        ...
                        <!-- Second Form -->
                        <form class="form-container" style="flex: 1; width: 48%;" action="/importId" method="POST" enctype='multipart/form-data'>
