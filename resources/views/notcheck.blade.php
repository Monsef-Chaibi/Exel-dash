...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div>
            <form action="{{ route('partial.delivery') }}" method="POST" id="partialDeliveryForm">
                @csrf
                        ...
                        @foreach ($data as $index => $item)
                            <tr>
                                ...
                                <td id="gtnum_{{ $index }}" style="display: flex" data-th="Supplier Code">
                                    {{ $item->gtnum }}
                                    <svg id="copyIcon_{{ $index }}" style="margin-left: 20px; cursor: pointer;"
                ...
                <button type="button" onclick="showConfirmSemi()">dqwsl</button>

                <div class="btnstatus">
                    <div>
                        <button type="submit" class="warning1">Check</button>
                    </div>
                </div>
            </form>
        </div>
